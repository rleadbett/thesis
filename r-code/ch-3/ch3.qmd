...
Here I analyse the idler-frame failure time data from an overland iron ore conveyor.
...
To sample draws from the posterior I use four chains each 2000 draws long and with a burn in of 500 iterations and no thinning.
