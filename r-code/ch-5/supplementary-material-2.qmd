...
```{r}
#| label: function-get-n-divergencies
#| echo: false
#| cache: false
...
```{r}
#| label: function-posterior-predictive-sim-plots
#| echo: false
...
pdf(
  file.path(figure_path, "plot-pp-mu-pairs.pdf"),
  height = 6,
  width = 6
)
...
pdf(
  file.path(figure_path, "plot-pp-mu-parcoord.pdf"),
  height = 4,
  width = 6
)
p_parcoord_pp_mu
...
pdf(
  file.path(figure_path, "plot-pp-nu-parcoord.pdf"),
  height = 4,
  width = 6
)
p_parcoord_pp_nu
