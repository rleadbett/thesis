...
\begin{table}
  ...
  \begin{minipage}{.3\textwidth}
    \includegraphics[width=0.8\textwidth, draft]{co-author-signatures/AP-sig.JPG}
  \end{minipage} & 12/08/2024\\
  2 & Professor Melinda Hodkiewicz & 
  \begin{minipage}{.3\textwidth}
    \includegraphics[width=0.8\textwidth, draft]{co-author-signatures/MH-sig.JPG}
  \end{minipage} & 12/08/2024\\
  3 & Associate Professor Adriano Polpo &
  \begin{minipage}{.3\textwidth}
    \includegraphics[width=0.8\textwidth, draft]{co-author-signatures/APC-sig.JPG}
  \end{minipage} & 13/08/2024\\
  4 & Gabriel Gonz\'{a}lez C\'{a}ceres &
  \begin{minipage}{.3\textwidth}
    \includegraphics[width=0.8\textwidth, draft]{co-author-signatures/GGC-sig.JPG}
  \end{minipage} & 12/08/2024\\
  \bottomrule
  \end{tabularx}
\end{table}
